...
export const metadata: Metadata = {
  ...
  description:
    "For sixty years, Mumbai's Kaali Peeli taxi drivers ruled the streets with nothing but muscle memory, street smarts, and zero digital help. They were the OG AIs with actual intelligence, navigating traffic that Google Maps still can't decode. Analysis by Mayank Singhal.",
  alternates: {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: "Meter Down Mafia: Mumbai's OG Hustlers"
    }],
  },
  twitter: {
    ...
    title: "Meter Down Mafia: Mumbai's OG Hustlers Ran This City - No GPS Required",
    description:
      "For sixty years, Mumbai's Kaali Peeli taxi drivers ruled the streets with nothing but muscle memory, street smarts, and zero digital help.",
...
export default function MeterDownMafia() {
  return (
    <TweetLayout
    ...
    >
      <div className="text-base md:text-lg leading-relaxed space-y-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-foreground/80">
          <li>How a scrappy Italian car became Mumbai's unofficial mascot.</li>
          <li>Why Kaali Peeli drivers were the OG AIs - but with actual intelligence.</li>
          <li>The secret sauce that made these taxis more than just a ride - they were a way of life.</li>
        </ul>
        ...
        <blockquote className="border-l-4 border-foreground/20 pl-4 italic text-foreground/80 bg-foreground/5 p-4 rounded-r-lg">
          <p><strong>"You can't automate hustle. You can only live it."</strong></p>
        </blockquote>
        ...
        <blockquote className="border-l-4 border-foreground/20 pl-4 italic text-foreground/80 bg-foreground/5 p-4 rounded-r-lg">
          <p><strong>"In Mumbai, the fastest route is the one only your cabbie knows."</strong></p>
        </blockquote>
        ...
        <blockquote className="border-l-4 border-foreground/20 pl-4 italic text-foreground/80 bg-foreground/5 p-4 rounded-r-lg">
          <p><strong>"Every Kaali Peeli is a confession box on wheels."</strong></p>
        </blockquote>
        ...
        <blockquote className="border-l-4 border-foreground/20 pl-4 italic text-foreground/80 bg-foreground/5 p-4 rounded-r-lg">
          <p><strong>"In Mumbai, the meter runs on stories - not just fuel."</strong></p>
        </blockquote>
        ...
        <blockquote className="border-l-4 border-foreground/20 pl-4 italic text-foreground/80 bg-foreground/5 p-4 rounded-r-lg">
          <p><strong>"Apps can get you there faster. Only Kaali Peelis got you there wiser."</strong></p>
        </blockquote>
        ...
        <blockquote className="border-l-4 border-foreground/20 pl-4 italic text-foreground/80 bg-foreground/5 p-4 rounded-r-lg">
          <p><strong>"Maps show routes. Drivers show reality."</strong></p>
        </blockquote>
