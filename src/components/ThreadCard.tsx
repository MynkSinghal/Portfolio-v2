...
export default function ThreadCard({ thread }: ThreadCardProps) {
  ...
  return (
    ...
    >
      <div className="relative p-6 rounded-2xl hover:shadow-xl hover:shadow-black/5 hover:-translate-y-1 transition-all duration-300 ease-out h-[200px] border border-foreground/10 overflow-hidden group bg-white/60 backdrop-blur-sm tilt">
